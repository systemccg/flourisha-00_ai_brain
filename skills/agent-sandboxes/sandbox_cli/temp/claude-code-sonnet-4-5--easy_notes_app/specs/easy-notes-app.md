...
- Update `index.html` to include workflow ID in title: `<title>claude-code-sonnet-4-5--easy_notes_app - Notes App</title>`
...
10. ✅ HTML page title includes workflow ID: "claude-code-sonnet-4-5--easy_notes_app"
...
# Test frontend loads
curl http://localhost:5173 | grep "claude-code-sonnet-4-5--easy_notes_app"
...
- HTML title must start with workflow ID: "claude-code-sonnet-4-5--easy_notes_app"
