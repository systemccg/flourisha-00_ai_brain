 ...
 *
 * Main Flourisha session initialization hook that runs at the start of every Claude Code session.
 *
 ...
 * - Calls load-core-context.ts to inject Flourisha context into the session
 *
 * Setup:
 * 1. Set environment variables in settings.json:
 *    - DA: Your AI's name (e.g., "Flourisha", "Kai", "Assistant")
